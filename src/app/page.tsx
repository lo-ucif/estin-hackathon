...
const imgHero = "https://www.figma.com/api/mcp/asset/acef9e41-41c0-4693-800f-d44fa4ffd1d4";
const imgUnderline = "https://www.figma.com/api/mcp/asset/3ea429b8-9a56-47d7-be66-306c4fd480f2";
const imgReady = "https://www.figma.com/api/mcp/asset/a81197bb-76e4-49d8-b010-46a6e8257e2d";
...
const features = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
        <path d="M10 20V12.5C10 11.837 10.2634 11.2011 10.7322 10.7322C11.2011 10.2634 11.837 10 12.5 10C13.163 10 13.7989 10.2634 14.2678 10.7322C14.7366 11.2011 15 11.837 15 12.5V20M10 16.25H15M20 10V20" stroke="#4023CB" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    quote: "Reduced our hiring. It finds the perfect talent before we even finish the post.",
  },
  {
    name: "Malik Ziane",
    role: "Technical Lead",
    ...
    <div className="space-y-16 pb-8">
      <section className="flex flex-col items-center pt-4 text-center">
        ...
        <p className="mt-5 max-w-3xl text-sm text-[#44474e] md:text-xl md:leading-8">
          Instant AI-driven job and talent matching for the future of work. Bridge the gap between
          human potential and machine intelligence with high-fidelity neural alignments.
        </p>
      ...
      <section id="how" className="grid items-center gap-8 md:grid-cols-[1fr_0.95fr] md:gap-12">
        <div>
          <h2 className="ai-display text-[40px] leading-[1.1] md:text-[72px]">How AI Job works</h2>
          <img src={imgUnderline} alt="" className="mt-2 h-8 w-[320px] max-w-full object-contain md:w-[455px]" />
          <p className="mt-4 max-w-xl text-xl leading-8 text-[#44474e] md:text-[32px] md:leading-[1.25]">
            Our system learns what matters to you and surfaces opportunities that fit. No noise, no
            wasted time, just the matches that count.
          </p>
        </div>
        <div className="flex justify-center md:justify-end">
          <img src={imgHero} alt="AI job matching hero" className="h-auto w-full max-w-[620px] object-contain" />
        </div>
      </section>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {features.map((feature) => (
            ...
            >
              ...
              <p className="text-[20px] font-bold text-[#1a1c1e]">{feature.title}</p>
              <p className="mt-4 text-sm leading-6 text-[#44474e]">{feature.text}</p>
            </article>
          ))}
        </div>
      </section>

      <section id="ready" className="grid items-center gap-8 md:grid-cols-[1fr_0.7fr]">
        <div>
        ...
        <div className="flex justify-center md:justify-end">
          <img src={imgReady} alt="Ready to start" className="h-auto w-full max-w-[501px] object-contain" />
        </div>
      </section>
      ...
      <section className="grid gap-5 md:grid-cols-3">
        {testimonials.map((item) => (
          <article key={item.name} className="bg-white px-6 py-5">
            ...
            <p className="text-sm font-semibold text-[#202430]/50">{item.name}</p>
            <p className="text-sm text-[#202430]/50">{item.role}</p>
            <p className="mt-4 text-[27px] leading-none text-[#4640de]">“</p>
            <p className="mt-1 text-lg font-semibold leading-8 text-[#202430]">{item.quote}</p>
          </article>
        ))}
      </section>
    </div>
